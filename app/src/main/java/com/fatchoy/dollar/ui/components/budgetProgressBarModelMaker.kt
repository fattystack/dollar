...
internal fun BudgetProgressBarModelMaker(
    ...
    val ringColor = when {
        progress >= 0.9 -> Color(0XFFD95C5C)
        progress >= 0.7 -> Color(0XFFE8A200)
        else -> Color(0XFF9CAF88)
    }
    ...
    BoxWithConstraints(
        ...
        val innerDiameter: Dp = (parentSize - strokeWidth * 2f).coerceAtLeast(0.dp)
        val iconSize: Dp = (innerDiameter * iconScale).coerceAtLeast(0.dp)
